                        ...
                        <table class="min-w-full bg-white border border-gray-300">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="py-2 px-4 border">Option</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($anneeScolaires as $anneeScolaire)
                                    <tr class="hover:bg-gray-100 text-center">
                                        ...
                                        <td class="py-2 px-4 border"> {{\Carbon\Carbon::parse($anneeScolaire->debut)->format('Y').' - '.\Carbon\Carbon::parse($anneeScolaire->fin)->format('Y')}}</td>
                                        @php
                                        ...
                                        <td class="py-2 px-4 border mt-4 text-center">
                                            <a class="bg-blue-500 text-white py-1 px-4 rounded" href="{{route('directeur.choix', $anneeScolaire->id)}}">Choisir</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
